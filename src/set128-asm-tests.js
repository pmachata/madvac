...
assert.strictEqual(asm.bs_select(0x08), 0x101, "select 0x8");
assert.strictEqual(asm.bs_select(0x0c), 0x110, "select 0xc");
assert.strictEqual(asm.bs_select(0x10), 0x201, "select 0x10");
assert.strictEqual(asm.bs_select(0x14), 0x210, "select 0x10");
