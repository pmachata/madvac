...
csp.simplify();
assert.strictEqual(csp.conses.size, 1, "1: conses.size");
assert.strictEqual(csp.knowns.size, 0, "1: knowns.size");

var csp = new CSP();
csp.pushCons(new Cons([1, 3, 5], 3));
csp.simplify();
assert.strictEqual(csp.conses.size, 0, "2: conses.size");
...
csp.simplify();
assert.strictEqual(csp.conses.size, 0, "3: conses.size");
...
csp.simplify();
assert.strictEqual(csp.conses.size, 0, "3a: conses.size");
...
csp.simplify();
assert.strictEqual(csp.conses.size, 0, "4: conses.size");
...
csp.pushCons(new Cons([1, 3, 5], 3));
csp.simplify();
assert.strictEqual(csp.conses.size, 0, "4a: conses.size");
